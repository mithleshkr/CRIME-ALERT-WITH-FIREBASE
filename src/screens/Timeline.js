         ...
         <div className='post'style={{overflow:"auto"}} >
          ...
          <li style={{textAlign:"center"}}>{post.data.about}<span style={{display:"flex",justifyContent:"flex-end",color:"red"}}>
              ...
              <Dialog open={open} onClose={handleClose}>
                  ...
                  <Button type="submit" onClick={()=>deletePost(post.id) + navigate('/home')} color="secondary" variant="contained">Yes</Button><Button onClick={()=>  window.location.reload(false)} color="primary" variant='contained'>No</Button>
                  </div>
              </Dialog>
